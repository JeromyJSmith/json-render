...
export async function POST(req: Request) {
  ...
  // Use official AI SDK function to convert UIMessages to model format
...
YOUR ROLE:
1. Answer questions about the presentation content
...
4. If a question is about a future slide topic, say "We'll cover that in detail shortly"
...
- Relate answers back to the current slide context when available
